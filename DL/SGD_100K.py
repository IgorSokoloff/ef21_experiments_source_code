...
#            wcfg.cmd_output_ready.release()
        ...
        if wcfg.cmd == "bcast_g_c0":
            ...
            #================================================================================================================================
            #All error feedback stuff and compression skipped
            #================================================================================================================================
            wcfg.output_of_cmd = g_batch_next
            model.train(prev_train_mode)

            transfered_bits_by_node[wcfg.worker_id, iteration] = ncfg.D * ncfg.component_bits_size #Updated beacuse we send full vectors
...
def main():
    ...
    parser.add_argument('--k', action='store', dest='k', type=int, default=11_689_512, help='Sparcification parameter')
    ...
    if nn_config.i_use_vr_biased_diana: prefix4algo = "SGD"
